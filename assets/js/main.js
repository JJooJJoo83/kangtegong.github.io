var Zepto = function() {
    ...
    }), X.Z.prototype = j.fn, X.uniq = T, X.deserializeValue = x, j.zepto = X, j
}();
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto),
    ...
    function(t) {
        ...
        S.href = window.location.href, t.active = 0, t.ajaxJSONP = function(e, n) {
            ...
            var g, x = i.accepts[p],
                ...
                j = i.xhr(),
                T = j.setRequestHeader;
            if (c && c.promise(j), i.crossDomain || w("X-Requested-With", "XMLHttpRequest"), w("Accept", x || "*/*"), (x = i.mimeType || x) && (x.indexOf(",") > -1 && (x = x.split(",", 2)[0]), j.overrideMimeType && j.overrideMimeType(x)), (i.contentType || i.contentType !== !1 && i.data && "GET" != i.type.toUpperCase()) && w("Content-Type", i.contentType || "application/x-www-form-urlencoded"), i.headers)
            ...
            var k = !("async" in i) || i.async;
            j.open(i.type, i.url, k, i.username, i.password);
            for (v in b) T.apply(j, b[v]);
    ...
    function(t, e, n) {
        t("a#slide").click(function() {
            ...
            t("#sidebar").hasClass("slide") && ("s" === e.key ? (t("#fade").trigger("click"), t("#search").trigger("click")) : t("#sidebar ul").find("[key-trigger='" + e.key + "']").trigger("click")), t(".search-form").hasClass("active") && "Escape" === e.key && t(".icon-remove-sign").trigger("click")
        }), t(document).keyup(function(e) {
            t(".search-form").hasClass("active") ? t(".search-form").find("input").focus() : t(".search-form").find("input").blur()
        });
        var r = {
        ...
        r.dothis.on("click", function() {
            t(".search-wrapper").toggleClass("active"), r.searchform.toggleClass("active"), r.canvas.toggleClass("search-overlay"), t(".search-field").simpleJekyllSearch()
